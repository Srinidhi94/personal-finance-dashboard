        ...
        for page_num, page in enumerate(pdf.pages):
            ...
            if "Domestic Transactions" in text:
                ...
                for table in tables:
                    ...
                    for row in table:
                        if len(row) >= 3 and any(header in str(row) for header in ["Date", "Transaction Description", "Amount"]):
                    ...
                    for i, row in enumerate(table):
                        if row and any(header in str(cell) for cell in row 
                                       for header in ["Date", "Transaction Description", "Amount"]):
                            header_row = i
