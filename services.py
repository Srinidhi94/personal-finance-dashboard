    ...
    def _migrate_accounts():
        ...
        try:
            ...
            for account_info in accounts:
                existing_account = Account.query.filter_by(name=account_info.get("account_name", "Unknown")).first()
    ...
    def _migrate_transactions():
        ...
        try:
            ...
            for transaction_data in transactions_data:
                ...
                account = (
                    Account.query.filter_by(name=transaction_data.get("account_name", "Default Account")).first()
                    or default_account
                )
